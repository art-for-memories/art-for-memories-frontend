        ...
        <section className="py-12 md:py-24 bg-neutral-50">
            <div className="container mx-auto px-4">
                <div className="mb-12 md:mb-24 text-center max-w-6xl mx-auto">
                    <h1 className="mb-16 font-semibold text-4xl md:text-6xl font-heading text-slate-700"><span>Join the community, <br /> and change</span>              <span className="bg-orange-50 rounded-lg px-4 mt-1 inline-block">the future.</span></h1>
                    ...
                    <div className="flex flex-wrap -m-2.5">
                        <div className="w-full md:w-1/2 xl:w-8/12 p-2.5">
                            <div className="h-full p-10 bg-white rounded-3xl">
                                <div className="mb-24">
                                    <h4 className="mb-2 text-5xl font-medium tracking-tight font-heading text-slate-700">Digital app</h4>
                            ...
                            <div className="h-full p-10 bg-white rounded-3xl">
                                <div className="flex flex-col justify-between h-full">
                                    <div className="w-full">
                                        <h4 className="mb-2 text-4xl font-medium tracking-tight font-heading text-slate-700">Content marketing</h4>
                        ...
                        <div className="w-full md:w-1/2 xl:w-1/3 p-2.5">
                            <div className="h-full p-10 bg-white rounded-3xl">
                                <div className="flex flex-col justify-between h-full">
                                    <div className="w-full">
                                        <h4 className="mb-2 text-4xl font-medium tracking-tight font-heading text-slate-700">Email marketing</h4>
                        ...
                        <div className="w-full md:w-1/2 xl:w-1/3 p-2.5">
                            <div className="h-full p-10 bg-white rounded-3xl">
                                <div className="flex flex-col justify-between h-full">
                                    <div className="w-full">
                                        <h4 className="mb-2 text-4xl font-medium tracking-tight font-heading text-slate-700">User-flow</h4>
