        ...
        <section className="px-6 py-20 md:px-10 lg:px-16 bg-white">
            <div className="flex flex-col md:flex-row items-center justify-between mx-auto px-6">
                ...
                <div className="md:w-1/2 text-center md:text-left">
                    <h2 className="text-3xl md:text-6xl mb-7 font-semibold font-heading text-slate-700 capitalize">Their Stories</h2>
                    ...
                    <div className="mt-7 flex flex-col sm:flex-row items-center justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-3">
