                        ...
                        <div className="flex flex-col h-full justify-center p-10 bg-white rounded-3xl">
                            <div className="flex flex-wrap items-center -m-3 mb-5">
                                ...
                                <div className="flex-1 p-3">
                                    <h4 className="text-4xl font-medium tracking-tight font-heading max-w-xs text-slate-800 text-slate-700">Customized Campaigns</h4>
                                </div>
                            </div>
                    ...
                    <div className="relative xl:top-20 w-full md:w-1/2 xl:w-1/3 p-3">
                        <div className="mb-6 p-10 bg-white rounded-3xl">
                            <div className="flex flex-wrap items-center -m-3 mb-5">
                                ...
                                <div className="flex-1 p-3">
                                    <h4 className="text-4xl font-medium tracking-tight font-heading max-w-xs text-slate-800">Data-Driven Insights</h4>
                                </div>
                            </div>
                        ...
                        <div className="p-10 bg-white rounded-3xl">
                            <div className="flex flex-wrap items-center -m-3 mb-5">
                                ...
                                <div className="flex-1 p-3">
                                    <h4 className="text-4xl font-medium tracking-tight font-heading max-w-xs text-slate-800">Customer Support</h4>
                                </div>
                            </div>
                    ...
                    <div className="relative xl:top-40 w-full xl:w-1/3 p-3">
                        <div className="flex flex-col h-full justify-center p-10 bg-white rounded-3xl">
                            <div className="flex flex-wrap items-center -m-3 mb-5">
                                ...
                                <div className="flex-1 p-3">
                                    <h4 className="text-4xl font-medium tracking-tight font-heading max-w-xs text-slate-800">A/B Testing and Optimization</h4>
                                </div>
                            </div>
