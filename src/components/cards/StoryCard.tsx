            ...
            <div className="h-full bg-white rounded-3xl px-6 md:px-12 py-12">
                ...
                <div className="flex flex-wrap gap-6 mb-14">
                    <div className="flex items-center gap-2">
                        ...
                        <p className="text-neutral-600 font-medium tracking-tight">{props.role}</p>
                    </div>
                    <div className="flex items-center gap-2">
                ...
                <div className="flex items-center justify-between flex-wrap gap-4">
                    ...
                    <a className="inline-flex text-slate-800 justify-center items-center text-center h-16 p-5 font-semibold tracking-tight text-xl hover:text-white focus:text-white bg-white hover:bg-neutral-900 focus:bg-neutral-900 border border-neutral-900 rounded-lg focus:ring-4 focus:ring-neutral-400 transition duration-200" href="#">
                        Read more
                    </a>
                </div>
            </div>
