                ...
                <tbody>
                    ...
                    {data.map((art) => (
                        <tr key={art.id} className="focus:outline-none h-16 border border-gray-100 rounded-lg bg-white text-black text-sm">
                            ...
                            <td className="p-4">
                                <Image src={art.oldPhoto} alt={art.name} width={50} height={50} />
                            </td>
                            <td className="p-4">
                                <Image src={art.preservedPhoto} alt={art.name} width={50} height={50} />
                            </td>
                            <td className="p-4">
                                <button onClick={() => onPreview && onPreview(art)} className="text-gray-500 ml-2 hover:text-red-500 bg-gray-200 rounded-xl p-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-4">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z" />
                                    </svg>
                                </button>

                                <button onClick={() => onDelete(art.id)} className="text-gray-500 ml-2 hover:text-red-500 bg-red-200 rounded-xl p-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-4">
